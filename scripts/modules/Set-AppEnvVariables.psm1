function Set-AppEnvVariables {
  ...
  Write-Host "[INFO] Environment variables set for '$CloudEnv'" -ForegroundColor Green
}

Export-ModuleMember -Function Set-AppEnvVariables